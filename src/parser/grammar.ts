...
export var ParserRules: NearleyRule[] = [
    ...
    {"name": "wschar", "symbols": [/[ \t\n\v\f]/], "postprocess": id},
    {"name": "dice", "symbols": ["unsigned_int", {"literal":"d"}, "dice_kind"], "postprocess": ([noDice, _1, _2, _3, dice]) => ({ noDice, dice })},
    {"name": "dice_kind", "symbols": [{"literal":"F"}], "postprocess": () => [-1, 0, 1]},
    {"name": "dice_kind", "symbols": ["unsigned_int"], "postprocess":  ([d]) => {
            const diceArray = [];
            for (let i=1; i <= d; i++) {
                diceArray.push(i);
            }
...
export var ParserStart: string = "dice";
